...
export const PublicPostsList = ({ posts, userId }: Props) => {
  ...
  return (
    <>
      {isMobile ? (
        <PostsListMobile posts={currentPosts.items} userId={userId} />
      ) : (
        <PostsListDesktop posts={currentPosts.items} userId={userId} />
      )}
