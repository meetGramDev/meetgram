...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|_next/static|_next/image|favicon.ico|icon.svg|apple-touch-icon.png|site.webmanifest|images|github|terms-of-service|privacy-policy|public-page|profile|payment).*)',
  ],
}
